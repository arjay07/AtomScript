...
INSTALLATION-
Follow the instructions below to install AtomScript onto your computer.

1. Make sure you have the latest version of Java installed.
2. Run the AtomScript Setup program.
3. After installing, a tutorial should start.
4. After you have finished the tutorial, you can run some example programs!

NOTEPAD++-
AtomScript comes with a syntax file for Notepad++. If you don't have Notepad++,
download it at https://notepad-plus-plus.org/download .
Afterwards:
1. Open the Notepad++.
2. Go to: Language -> Define your language... -> Import
3. Import the AtomScript.xml file.

RUNNING-
Running an AtomScript program is easy. Create an AtomScript file by creating a text file with 
the .atom extension. Write some code in the file and then double click on it to run the 
